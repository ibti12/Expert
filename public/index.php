...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <style>
           a {
            color:#4f4528;; /* Couleur du lien brun */
        ...
        a:hover {
            color: #CD853F; /* Changement de couleur au survol */
            text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.3); /* Ombre portée */
        }
        ...
        /* Style pour le conteneur de votre contenu */
        .container {
...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    <div class="container">
        ...
        <img src="{{ asset('image/track.png') }}" alt="Nom de l'image" class="image">
    </div>
</body>
</html>