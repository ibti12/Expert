...
@php
    $b_commandes = App\Models\BCommande::all();
@endphp       
<div class="container">
...
<form class="edit-form" method="POST" action="{{ route('b_commande.update', ['id' => $b_commande->id]) }}">
    @csrf
    @method('put')

    <div class="form-group">
        <label for="N°">N°:</label>
        <input type="text" id="N°" name="N°" class="form-control" value="{{ $b_commande->N°}}">
    </div>

    <div class="form-group">
        <label for="date">Date :</label>
        <input type="date" id="date" name="date" class="form-control" value="{{ $b_commande->date }}">
    </div>
     <div class="form-group">
        <label for="nom">Client :</label>
        <input type="text" id="nom" name="nom" class="form-control" value="{{ $b_commande->nom}}">
    </div>
     <div class="form-group">
        <label for="plus">Plus :</label>
      
         <textarea id="plus" name="plus" class="form-control" >{{ $b_commande->plus}}</textarea>
    </div>
