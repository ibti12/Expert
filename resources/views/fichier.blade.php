...
<style>
    .scroll-back {
   position: fixed;
    bottom:240px; /* Ajustez la position verticale selon vos préférences */
...
<style>
    ...
    Ajouter une entreprise/client </a>
</div>
...
<div class="card">
    <div class="card-header">Client {{ $cl->NOM }}</div>
    <div class="card-body">
        <div class="info">
       ...
       <a href="/client/details/{{ $cl->id }}" class="link">Voir les détails</a>
    </div>
</div>
@endforeach
