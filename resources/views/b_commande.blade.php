    ...
    <table border="1" id="rapportTable">
        ...
        <tbody>
            ...
            <tr>
               ...
               <td>
                <a href="/b_commande/{{ $b_commandes->id }}/edit" style="background-color: #4f4528; color: white;" class="imprimerButton">
            <i class="fa fa-edit"></i>
        </a>
        <a href="#" onclick="event.preventDefault(); if(confirm('Êtes-vous sûr de vouloir supprimer ce bon de commande ?')) { document.getElementById('delete-form-{{ $b_commandes->id }}').submit(); }" class="imprimerButton">
