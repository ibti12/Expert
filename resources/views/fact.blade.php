 ...
 <form id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 navbar-search" action="{{ route('factures.recherche') }}" method="get">
    <div class="input-group">
        <input type="text" class="form-control bg-light border-0 small" placeholder="Search for..."
            aria-label="Search" aria-describedby="basic-addon2"  name="numero" style="max-width: 380px;">
        <div class="input-group-append">
            <button class="btn boton-marron" type="submit"> <!-- Ajoutez type="submit" pour soumettre le formulaire -->
...
<a  style="background-color: #4f4528; color: #fff; border: none; border-radius: 5px; padding: 10px 20px; cursor: pointer;"class="deleteButton" href="{{ route('factures.recap') }}">Recap</a>
...
<form id="delete-form-{{ $facture->id }}" action="{{ route('factures.destroy', $facture->id) }}" method="post" style="display: none;">
  ...
  <!-- Bouton de référence -->
  <a style="background-color: #4f4528; color: #fff; border: none; border-radius: 5px; padding: 10px 20px; cursor: pointer;" class="deleteButton" href="{{ route('references.show', ['numero' => $facture->numero]) }}">
    References
</a>
&nbsp;
<a  style="background-color: #4f4528; color: #fff; border: none; border-radius: 5px; padding: 10px 20px; cursor: pointer;"class="deleteButton"  href="{{ route('reference.generefacture' ,['numero' => $facture->numero]) }}"><i class="fa fa-print"></i></a>
            </tr>
