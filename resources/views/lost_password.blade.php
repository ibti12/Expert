...
<div class="form-bg">
    <div class="container">
            ...
            <div class="col-md-offset-4 col-md-4 col-sm-offset-3 col-sm-6">
                <div class="form-container">
                    <form class="form-horizontal">
                        <h3 class="title">Formulaire réinitialisation de mot de passe</h3>
                        ...
                        <button type="submit" class="btn signin">Réinitialiser le mot de passe</button>
                        <span class="signin-link">Vous avez déjà un compte ? Cliquez ici pour <a href="index">Connexion</a></span><br> <br>
       ...
       <style>
     a {
    color: #a48e6b; /* Marron clair */
    text-decoration: none; /* Pour enlever le soulignement du lien */
}

a:hover {
    color: #b4a281; /* Marron encore plus clair au survol */
}
        body {
