...
<style>
    .scroll-back {
   position: fixed;
    bottom: 365px; /* Ajustez la position verticale selon vos préférences */
    right: 1215px; /* Ajustez la position horizontale selon vos préférences */
...
<div class="container">
    <br>
    <br><br>
<h1> Les dossiers du  client : {{ request('client_nom') }}</h1>
...
@endforeach
            ...
            <td>
                ...
                <td>
                    <a href="/dossiers/{{ $dossier->id }}/edit" class="imprimerButton"> editer</a><br><br>
                         <a href="#" onclick="event.preventDefault(); if(confirm('Êtes-vous sûr de vouloir supprimer ce déplacement ?')) { document.getElementById('delete-form-{{ $dossier->id }}').submit(); }" class="imprimerButton"> supprimer</a>
...
input[type="checkbox"]:checked {
    ...
    padding: 10px 20px;
    background-color: #4f4528; /* Couleur de fond */
